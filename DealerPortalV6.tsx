...
export default function DealerPortalV6() {
  ...
  return (
    ...
    {anyVisible(["dealer.consignor_guest.my_units", "dealer.consignor_guest.offers_bids", "dealer.consignor_guest.payouts"]) && <div className="nav-section">
      ...
      {canSeePage("dealer.consignor_guest.my_units") && (!pageMeta["dealer.consignor_guest.my_units"].scoped_role || pageMeta["dealer.consignor_guest.my_units"].scoped_role === userRole) && <div className={`nav-item ${isNavActive("dealer.consignor_guest.my_units") ? "active" : ""}`} onClick={() => showPage("dealer.consignor_guest.my_units")}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><rect x="1" y="3" width="15" height="13" rx="2"/><path d="M16 8h4a2 2 0 012 2v6a2 2 0 01-2 2h-4"/><circle cx="5.5" cy="18" r="2.5"/><circle cx="18.5" cy="18" r="2.5"/></svg>My Consigned Unit(s)</div>}
      {canSeePage("dealer.consignor_guest.offers_bids") && (!pageMeta["dealer.consignor_guest.offers_bids"].scoped_role || pageMeta["dealer.consignor_guest.offers_bids"].scoped_role === userRole) && <div className={`nav-item ${isNavActive("dealer.consignor_guest.offers_bids") ? "active" : ""}`} onClick={() => showPage("dealer.consignor_guest.offers_bids")}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><rect x="1" y="3" width="15" height="13" rx="2"/><path d="M16 8h4a2 2 0 012 2v6a2 2 0 01-2 2h-4"/><circle cx="5.5" cy="18" r="2.5"/><circle cx="18.5" cy="18" r="2.5"/></svg>Offers &amp; Bids on My Unit</div>}
      {canSeePage("dealer.consignor_guest.payouts") && (!pageMeta["dealer.consignor_guest.payouts"].scoped_role || pageMeta["dealer.consignor_guest.payouts"].scoped_role === userRole) && <div className={`nav-item ${isNavActive("dealer.consignor_guest.payouts") ? "active" : ""}`} onClick={() => showPage("dealer.consignor_guest.payouts")}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M20.59 13.41l-7.17 7.17a2 2 0 01-2.83 0L2 12V2h10l8.59 8.59a2 2 0 010 2.83z"/><line x1="7" y1="7" x2="7.01" y2="7"/></svg>My Payouts</div>}
    </div>}
    {anyVisible(["dealer.public_bidder_guest.my_bids", "dealer.public_bidder_guest.verification"]) && <div className="nav-section">
      ...
      {canSeePage("dealer.public_bidder_guest.my_bids") && (!pageMeta["dealer.public_bidder_guest.my_bids"].scoped_role || pageMeta["dealer.public_bidder_guest.my_bids"].scoped_role === userRole) && <div className={`nav-item ${isNavActive("dealer.public_bidder_guest.my_bids") ? "active" : ""}`} onClick={() => showPage("dealer.public_bidder_guest.my_bids")}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M12 20V10"/><path d="M18 20V4"/><path d="M6 20v-4"/></svg>My Bids (Public Bidder)</div>}
      {canSeePage("dealer.public_bidder_guest.verification") && (!pageMeta["dealer.public_bidder_guest.verification"].scoped_role || pageMeta["dealer.public_bidder_guest.verification"].scoped_role === userRole) && <div className={`nav-item ${isNavActive("dealer.public_bidder_guest.verification") ? "active" : ""}`} onClick={() => showPage("dealer.public_bidder_guest.verification")}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M12 20V10"/><path d="M18 20V4"/><path d="M6 20v-4"/></svg>Verification &amp; Payment</div>}
    </div>}
