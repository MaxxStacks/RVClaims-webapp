...
export default function NewDealershipPage() {
  ...
  return (
    <div style={{display: "flex", minHeight: "100vh", background: "#f7f9fc"}}>
      <div style={{width: 240, background: "white", borderRight: "1px solid #e5eaf2", padding: 24}}>
        ...
        {STEPS.map((s, i) => (
          <div key={s} style={{
            ...
            background: step === i ? "#eaf1fb" : "transparent",
            ...
            <span style={{width: 20, height: 20, borderRadius: 10,
              background: i < step ? "#16a34a" : step === i ? "#033280" : "#d5dbe5",
      ...
      <div style={{flex: 1, padding: 32, maxWidth: 800}}>
          ...
          <div style={{display: "grid", gap: 12}}>
            {TIERS.map(t => (
              <div key={t.key} onClick={() => setTier(t.key)}
                style={{
                  padding: 20, border: tier === t.key ? "2px solid #033280" : "1px solid #e5eaf2",
                  borderRadius: 8, cursor: "pointer", background: tier === t.key ? "#f0f5ff" : "white",
                }}>
        ...
        {step === 2 && (
          <div>
            ...
            {catalog.length === 0 ? (
              <div style={{padding: 24, background: "#fafbfd", borderRadius: 8, fontSize: 12, color: "#888"}}>
                ...
                {catalog.map((mod: any) => {
                  ...
                  return (
                    <div key={mod.moduleKey}
                      ...
                      style={{
                        padding: 14, border: "1px solid #e5eaf2", borderRadius: 6,
                        background: isEnabled ? "#f0f5ff" : "white",
        ...
        {step === 3 && (
          <div style={{padding: 20, background: "white", borderRadius: 8, border: "1px solid #e5eaf2"}}>
            ...
            <div style={{padding: 12, background: "#f7f9fc", borderRadius: 6, fontSize: 12}}>
        ...
        <div style={{display: "flex", justifyContent: "space-between", marginTop: 32}}>
          <button onClick={back} disabled={step === 0}
            style={{padding: "10px 18px", border: "1px solid #d5dbe5", background: "white", borderRadius: 6, cursor: step === 0 ? "default" : "pointer", opacity: step === 0 ? 0.5 : 1}}>
            ← Back
          </button>
          {step < STEPS.length - 1 ? (
            <button onClick={next} style={{padding: "10px 24px", background: "#033280", color: "white", border: 0, borderRadius: 6, cursor: "pointer", fontWeight: 600}}>
              Next →
            </button>
          ) : (
  ...
  return (
    <div>
      ...
      <input type={type || "text"} value={value} onChange={e => onChange(e.target.value)}
        style={{width: "100%", padding: "10px 12px", fontSize: 13, border: "1px solid #d5dbe5", borderRadius: 6}}/>
    </div>
  );
}
