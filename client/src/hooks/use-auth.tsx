...
interface AuthContextValue {
  ...
  login: (email: string, password: string, portal?: "dealer" | "operator") => Promise<{ success: boolean; message?: string }>;
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const login = useCallback(
    async (email: string, password: string, portal?: "dealer" | "operator") => {
