    ...
    <>
      <nav className={`sidebar${sidebarCollapsed ? ' collapsed' : ''}`}>
        ...
        <div className="sidebar-nav">
          ...
          <div className="nav-section">
            <div className="nav-label">My Units</div>
            ...
            <Link className={`nav-item ${isActive('offers') ? 'active' : ''}`} to="offers"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/></svg>Offers</Link>
            ...
            <Link className={`nav-item ${isActive('showcase') ? 'active' : ''}`} to="showcase"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/></svg>Showcase</Link>
          </div>
          <div className="nav-section">
            <div className="nav-label">Finance</div>
            <Link className={`nav-item ${isActive('payout') ? 'active' : ''}`} to="payout"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></svg>Payout Tracking</Link>
          </div>
          <div className="nav-section">
