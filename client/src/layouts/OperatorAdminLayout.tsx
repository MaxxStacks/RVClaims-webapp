      ...
      <nav className={`sidebar${sidebarCollapsed ? ' collapsed' : ''}`}>
        ...
        <div className="sidebar-nav">
          ...
          <div className="nav-section">
            ...
            <Link className={`nav-item ${isActive('suppliers') ? 'active' : ''}`} to="suppliers"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 7h-9"/><path d="M14 17H5"/><circle cx="17" cy="17" r="3"/><circle cx="7" cy="7" r="3"/></svg>{t('supplier.title') || 'Suppliers'}</Link>
          </div>
          <div className="nav-section">
          ...
          <div className="nav-section">
            ...
            <Link className={`nav-item ${isActive('analytics') ? 'active' : ''}`} to="analytics"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="2" width="20" height="20" rx="2"/><path d="M7 16l3-4 3 2 3-5"/></svg>{t('analytics.title')}</Link>
            <Link className={`nav-item ${isActive('compliance') ? 'active' : ''}`} to="compliance"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-4"/></svg>{t('compliance.title')}</Link>
