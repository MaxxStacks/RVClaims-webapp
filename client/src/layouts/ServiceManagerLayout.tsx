      ...
      <nav className={`sidebar${sidebarCollapsed ? ' collapsed' : ''}`}>
        ...
        <div className="sidebar-nav">
          ...
          <div className="nav-section">
            ...
            <Link className={`nav-item ${isActive('scheduling') ? 'active' : ''}`} to="scheduling"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>{t('nav.scheduling')}</Link>
            <Link className={`nav-item ${isActive('technicians') ? 'active' : ''}`} to="technicians"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>{t('nav.technicians')}</Link>
            ...
            <Link className={`nav-item ${isActive('service-appointments') ? 'active' : ''}`} to="service-appointments"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07"/></svg>{t('nav.serviceAppointments')}</Link>
