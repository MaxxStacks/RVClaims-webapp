...
export default function IndependentBidderLayout({ children }: Props) {
      ...
      <nav className={`sidebar${sidebarCollapsed ? ' collapsed' : ''}`}>
        <div className="sidebar-logo">
          ...
          <div className="sidebar-logo-text">
            ...
            <span className="sidebar-badge" style={{marginTop:4}}>Independent</span>
          </div>
        </div>
        <div className="sidebar-nav">
          ...
          <div className="nav-section">
            ...
            <Link className={`nav-item ${isActive('upcoming') ? 'active' : ''}`} to="upcoming"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>Browse Auctions</Link>
        ...
        <div className="sidebar-footer">
          <div className="user-info" style={{cursor:'pointer'}}>
            <div className="user-avatar">{user?.email ? user.email.slice(0,2).toUpperCase() : 'IB'}</div>
            <div>
              <div className="user-name">{user?.email ?? 'Independent Bidder'}</div>
              <div className="user-role">Independent Bidder</div>
            </div>
          </div>
        ...
        <header className="header">
          <div className="header-left">
            ...
            <div>
              ...
              <div className="header-sub">Independent Bidder</div>
            </div>
          </div>
