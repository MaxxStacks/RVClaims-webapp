...
<div className={`page ${activePage === 'batch-review' ? 'active' : ''}`} id="page-batch-review">
  <div className="detail-header"><button className="detail-back" onClick={() => showPage('queue')}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="15 18 9 12 15 6"/></svg></button><div className="detail-info"><div className="detail-title">BATCH-0048 — Photo Review</div><div className="detail-meta">Smith's RV Centre · Jayco · VIN: 1UJBJ0BN8M1TJ4K1 · Warranty · 24 photos</div></div><button className="btn btn-s btn-sm" onClick={() => handleToast('Claim created from groups')}>Create Claim from Groups</button></div>
