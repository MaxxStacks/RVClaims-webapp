  ...
  return (
    ...
    >
      <PageHero
        ...
        title={t('warrantyExtendedPage.subtitle')}
        description={t('warrantyExtendedPage.description')}
      />
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-3 text-foreground">
                      {t(`warrantyExtendedPage.${feature}.title`)}
                    </h3>
                    <p className="text-muted-foreground leading-relaxed">
                      {t(`warrantyExtendedPage.${feature}.description`)}
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact">
              <Button size="lg" className="w-full sm:w-auto" data-testid="button-contact-warranty">
