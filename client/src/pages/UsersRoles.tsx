...
export default function UsersRoles() {
  ...
  return (
    <div className="page active">
      <div className="tabs"><div className="tab active">Operator Staff (4)</div><div className="tab">Dealer Users (38)</div></div>
        ...
        <div className="filter-bar">
          ...
          <div style={{marginLeft: 'auto'}}>
            <button className="btn btn-p btn-sm" onClick={() => {
              ...
              const role = prompt('Role (operator_staff, dealer_owner, dealer_staff):');
              if (email && role) handleInviteUser(email, role);
            }}>+ Invite User</button>
          </div>
        </div>
