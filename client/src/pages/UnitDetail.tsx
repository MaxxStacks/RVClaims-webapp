...
export default function UnitDetail() {
  ...
  return (
    <div className="page active">
      ...
      <div className="tabs"><div className="tab active" onClick={() => setUnitTab('utab-u-specs')}>Specs</div><div className="tab" onClick={() => setUnitTab('utab-u-claims')}>Claims</div><div className="tab" onClick={() => setUnitTab('utab-u-photos')}>Photos</div><div className="tab" onClick={() => setUnitTab('utab-u-fin')}>Financials</div><div className="tab" onClick={() => setUnitTab('utab-u-time')}>Timeline</div></div>
