...
// POST /api/units/:id/assign-customer
...
// DELETE /api/units/:id/documents/:docId
...
// POST /api/units/:id/photos — presign-based: client POSTs metadata after R2 upload
...
// POST /api/units/batch-import — dealer_owner or dealer_staff
...
// GET /api/units/arrivals — pending_arrival units
...
// PATCH /api/units/:id/assign — operator_admin only
...
// POST /api/units/:id/send-daf-reminder — operator_admin only
